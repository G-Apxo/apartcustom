...
import Taghi from '../../assets/projectslogofire/sep15/bukhaidzeb2prjlogo.png';
                        ...
                        <div className='mob__view'>
                            <Row className='justify-content-between mt-5'>
                                ...
                                <Col xs='6' lg='6' md='6' sm='6' xl='2' xxl='2'>
                                    ...
                                    <h3 className='projects-floor-yard'>{t.treeNumb2}</h3>
                                </Col>
                                <Col xs='6' lg='6' md='6' sm='6' xl='3' xxl='3'>
                                    <hr />
                                    <p className='basic-texts-14'>{t.exhibitionSpace}</p>
                                    <h3 className='projects-floor-yard'>{t.esmb2}</h3>
                                </Col>
                            </Row>
                            <Row className='justify-content-between mt-5'>
