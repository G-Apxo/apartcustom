export default {
    ...
    bigBrain7: (
        <code>
            {' '}
            The real estate purchased from us is the best business{' '}
            <a href='/invest-in-real-estate-in-tbilisi'> investment,</a> and the guarantee of this is that the
            project is implemented in the old district of Tbilisi, in the most active touristic zone, which
            determines the high demand on apartments throughout the year.
        </code>
    ),
    bigBrain8: 'Spa',
