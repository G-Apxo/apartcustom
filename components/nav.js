      ...
      <Container className="mobile_container">
        <Row>
          ...
          <ul className="navbar-nav">
            <li className="mobile_social_platgorms "> <a href="tel:+995-32-2-11-11-44" className="soc__icon__mobile text-dark">+995 32 2 11 11 44</a><span className="soc__icon text-dark"> | </span>  </li>
            <li className="mobile_social_platgorms"> <a className="soc__icon__mobile text-dark" href="#">{t.v} </a> <span className="text-dark soc__icon"> |</span> </li>
            <li className="mobile_social_platgorms"><a className="soc__icon__mobile text-dark"href="#">{t.w}</a></li>
          </ul>
          </Col>
        ...
        <ul className="menu__box">
          <li><a className="menu__item" href="#">{t.about}</a></li>
          <li><a className="menu__item" href="#">{t.investing}</a></li>
          <li><a className="menu__item" href="#">{t.projects}</a></li>
          <li><a className="menu__item" href="#">{t.blog}</a></li>
          <li><a className="menu__item" href="#">{t.contact}</a></li>
